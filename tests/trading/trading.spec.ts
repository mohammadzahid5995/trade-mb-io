...
test.describe('Trading', () => {
    ...
    test('TRD007 spot trading section renders and displays trading pairs',
        async ({ page }) => {
    ...
    test('TRD009 trading pair entries contain expected data fields',
        async ({ page }) => {
    ...
    test('TRD008 trading pairs are correctly grouped into categories',
        async ({ page }) => {
